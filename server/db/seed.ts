...
const FIREARMS_SCHEMA = JSON.stringify([
  { key: 'serialNumber', label: 'Serial Number', type: 'text', required: true, group: 'Identification' },
  { key: 'caliber', label: 'Caliber', type: 'text', required: true, placeholder: 'e.g., 9mm, .223, 12ga', group: 'Specifications' },
  { key: 'barrelLength', label: 'Barrel Length', type: 'text', required: false, placeholder: 'e.g., 16"', group: 'Specifications' },
  { key: 'action', label: 'Action', type: 'select', required: false, options: ['Semi-Automatic', 'Bolt Action', 'Pump Action', 'Lever Action', 'Revolver', 'Single Shot', 'Full Auto'], group: 'Specifications' },
  { key: 'manufacturer', label: 'Manufacturer', type: 'text', required: false, group: 'Identification' },
  { key: 'triggerPull', label: 'Trigger Pull', type: 'text', required: false, placeholder: 'e.g., 5.5 lbs', group: 'Specifications' },
  { key: 'frame', label: 'Frame', type: 'select', required: false, options: ['Polymer', 'Aluminum', 'Steel', 'Titanium', 'Alloy'], group: 'Specifications' },
  { key: 'weight', label: 'Weight', type: 'text', required: false, placeholder: 'e.g., 30 oz', group: 'Specifications' },
  { key: 'fflRequired', label: 'FFL Required', type: 'boolean', required: false, group: 'Compliance' },
  { key: 'condition', label: 'Condition', type: 'select', required: false, options: ['New', 'Like New', 'Excellent', 'Very Good', 'Good', 'Fair', 'Poor'], group: 'Identification' },
]);

const ACCESSORIES_SCHEMA = JSON.stringify([
  { key: 'accessoryType', label: 'Accessory Type', type: 'select', required: false, options: ['Optic', 'Light', 'Laser', 'Grip', 'Magazine', 'Holster', 'Case', 'Mount', 'Suppressor', 'Bipod', 'Sling', 'Trigger', 'Muzzle Device', 'Other'], group: 'General' },
  { key: 'magnification', label: 'Magnification', type: 'text', required: false, placeholder: 'e.g., 1x, 1-6x, 3.25 MOA dot', group: 'Optics' },
  { key: 'reticleType', label: 'Reticle Type', type: 'select', required: false, options: ['Red Dot', 'Green Dot', 'Holographic', 'Crosshair', 'BDC', 'ACSS', 'MOA', 'MRAD', 'Duplex'], group: 'Optics' },
  { key: 'tubeDiameter', label: 'Tube Diameter', type: 'text', required: false, placeholder: 'e.g., N/A, 30mm, 34mm', group: 'Optics' },
  { key: 'objectiveLens', label: 'Objective Lens', type: 'text', required: false, placeholder: 'e.g., 20mm', group: 'Optics' },
  { key: 'eyeRelief', label: 'Eye Relief', type: 'text', required: false, placeholder: 'e.g., Unlimited, 3.5"', group: 'Optics' },
  { key: 'lumens', label: 'Lumens', type: 'text', required: false, placeholder: 'e.g., 1000, 2000', group: 'Illumination' },
  { key: 'candela', label: 'Candela', type: 'text', required: false, placeholder: 'e.g., 27,600', group: 'Illumination' },
  { key: 'beamDistance', label: 'Beam Distance', type: 'text', required: false, placeholder: 'e.g., 332m', group: 'Illumination' },
  { key: 'runtime', label: 'Runtime', type: 'text', required: false, placeholder: 'e.g., 1.5 hrs high', group: 'Illumination' },
  { key: 'activationMethod', label: 'Activation', type: 'select', required: false, options: ['Momentary', 'Constant', 'Strobe', 'Momentary/Constant', 'Programmable'], group: 'Illumination' },
  { key: 'mountType', label: 'Mount Type', type: 'text', required: false, placeholder: 'e.g., Picatinny, M-LOK, RMR footprint', group: 'Physical' },
  { key: 'batteryType', label: 'Battery Type', type: 'text', required: false, placeholder: 'e.g., CR2032, CR123A', group: 'Physical' },
  { key: 'weight', label: 'Weight', type: 'text', required: false, placeholder: 'e.g., 1.2 oz', group: 'Physical' },
  { key: 'manufacturer', label: 'Manufacturer', type: 'text', required: false, group: 'General' },
  { key: 'compatibility', label: 'Compatibility', type: 'text', required: false, placeholder: 'e.g., Glock MOS, Picatinny rail', group: 'General' },
  { key: 'condition', label: 'Condition', type: 'select', required: false, options: ['New', 'Like New', 'Excellent', 'Very Good', 'Good', 'Fair', 'Poor'], group: 'General' },
]);

const AMMUNITION_SCHEMA = JSON.stringify([
  { key: 'caliber', label: 'Caliber', type: 'text', required: true, placeholder: 'e.g., 9mm, .223, 12ga', group: 'Details' },
  { key: 'grainWeight', label: 'Grain Weight', type: 'number', required: false, placeholder: 'e.g., 115, 55', group: 'Details' },
  { key: 'cartridgeType', label: 'Cartridge Type', type: 'select', required: false, options: ['FMJ', 'JHP', 'SP', 'BTHP', 'Buckshot', 'Slug', 'Birdshot', 'Tracer', 'AP'], group: 'Details' },
  { key: 'roundCount', label: 'Rounds Per Box', type: 'number', required: false, placeholder: 'e.g., 50, 20', group: 'Details' },
  { key: 'casing', label: 'Casing', type: 'select', required: false, options: ['Brass', 'Steel', 'Aluminum', 'Nickel-Plated'], group: 'Details' },
  { key: 'manufacturer', label: 'Manufacturer', type: 'text', required: false, group: 'Details' },
]);
