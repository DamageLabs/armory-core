              ...
              <form [formGroup]="emailForm" (ngSubmit)="updateEmail()" class="space-y-4">
                ...
                <div class="pt-4">
                  <button
                    ...
                    class="bg-blue-600 hover:bg-blue-700 disabled:bg-slate-400 disabled:cursor-not-allowed text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200">
                    @if (isEmailLoading()) {
