  ...
  template: `
    <div class="space-y-6">
      ...
      <div class="bg-white dark:bg-slate-800 p-12 rounded-xl border border-slate-200 dark:border-slate-700 text-center">
        ...
        <h3 class="text-lg font-medium text-slate-900 dark:text-slate-100 mb-2">Inventory Type Management</h3>
        <p class="text-slate-500 dark:text-slate-400">Inventory type management features coming soon...</p>
      </div>
    </div>
  `
})
